...
void SweepSelectivity(int32_t max_inverse_selectivity, int32_t output_size)
{
         ...
         *inverse_selectivity_iter <= max_inverse_selectivity)
  {
    ...
    thrust::device_vector<int32_t> num_out_triple_1(1);
    thrust::device_vector<int32_t> num_out_triple_2(1);
    ...
    // Crystal non-order-preserving double compaction with initial shuffle from filter in 1st kernel
